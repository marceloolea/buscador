...
const dbConfig = require('./config/dbConfig'); // Importa tu archivo de configuración
...
app.set('view engine', 'ejs'); // Le dice a Express que use EJS como motor de vistas
app.set('views', path.join(__dirname, 'views')); // Le dice a Express dónde encontrar los archivos .ejs (la carpeta 'views' que creaste)

// --- Configuración de Sesiones (viene después) ---
// app.use(session({...}));
